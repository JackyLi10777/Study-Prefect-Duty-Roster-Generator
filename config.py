...
# 版本號更新，標記本次為舊版功能完整合併後的最終版
VERSION = "v2.2 (Legacy & Deep Space Integrated - Final)"
PAGE_ICON = "🦅"

# ==========================================
# 排班相關常數（保留舊版全部常數 + 最新版結構）
# ==========================================
...
# ==========================================
# NASA 深邃風格 統一顏色系統（沉穩專業版 + 修復 text_dark + 舊版顏色鍵補回）
# ==========================================
NASA_COLORS = {
    "header_bg": "#0B1E3D",
    "accent_gold": "#B8860B",
    
    # 舊版曾使用的預設文字顏色（補回，避免 KeyError）
    "text_dark": "#1F2937",
...
def get_role_style(role: str, day: str = "") -> dict:
    ...
    補回舊版所有角色判斷邏輯，並確保每個角色都有 bg / text / border 三個必要鍵
    """
    style = {
