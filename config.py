...
VERSION = "v2.0 (Final Integrated Version - Head Prefect Edition)"
PAGE_ICON = "🦅"
...
# ==========================================
# 每日聖經金句（Head Study Prefect 專用擴充版）
# 總數超過 200 句，主題：僕人領導、作榜樣、公平、公義、老帶新、忠心、謙卑、智慧、堅持
# ==========================================
DAILY_VERSES = {
    0: [ # Monday - 僕人領導與作榜樣
        "「你們中間誰願為大，就必作你們的用人。」——馬太福音 20:26",
        "「人子來，並不是要受人的服事，乃是要服事人。」——馬可福音 10:45",
        "「作監督的，必須無可指責，只作一個婦人的丈夫，有節制，自守，端正，樂意接待遠人，善於教導。」——提摩太前書 3:2",
        "「你們作領袖的，不要轄制所託付你們的，乃要作群羊的榜樣。」——彼得前書 5:3",
        "「我為你們作了榜樣，叫你們照著我向你們所做的去做。」——約翰福音 13:15",
        "「你們作僕人的，要凡事聽從你們肉身的主人，不要只在眼前服事。」——歌羅西書 3:22",
