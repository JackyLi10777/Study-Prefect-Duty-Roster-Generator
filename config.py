...
版本：v2.3 Final（已修正所有 SyntaxError + 完整 DAILY_VERSES + get_daily_slots）
"""
...
# Room 303 和 Room 202 各拆成兩行，確保顯示兩個 Prefect
ROWS_ROSTER = [
    "Assist. in charge",
    "Room 302 (Study Room)",
...
ROOMS_CONFIG = {
    ...
    "Room 202 (F1 Study Group)": {
        "daily_slots": 2,
        "weight": 1.5,
        "available_weekdays": ["MONDAY", "WEDNESDAY", "THURSDAY"],  # 星期二與星期五不開放
        "color": "room202",
        "allow_assistant_head_only": False,
